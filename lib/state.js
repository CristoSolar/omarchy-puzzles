...
// El rango 0..8 cubre los cuatro juegos: Queens y Tango usan 0-2, Sudoku 0-6, y
// Zip guarda el orden del camino, que valida su propia etapa.
function restoreInProgress(state, gameId, dateKey, cellCount) {
  ...
  for (var i = 0; i < wip.cells.length; i++) {
    var v = wip.cells[i];
    if (typeof v !== 'number' || !isFinite(v) || v < 0 || v > 8) return null;
  }
